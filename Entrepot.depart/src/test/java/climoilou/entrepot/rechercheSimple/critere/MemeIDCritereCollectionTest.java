 ...
 */
public class MemeIDCritereCollectionTest {
	private List<Item> source1;

	public MemeIDCritereCollectionTest() {
	}
	...
	public void getElementTrouveTest() {
		...
		MemeIDCritereCollection crit0 = new MemeIDCritereCollection(-5, source1, OrAndNot.OR);
		MemeIDCritereCollection crit1 = new MemeIDCritereCollection(0, source1, OrAndNot.OR);
		MemeIDCritereCollection crit2 = new MemeIDCritereCollection(1, source1, OrAndNot.OR);
		MemeIDCritereCollection crit3 = new MemeIDCritereCollection(50, source1, OrAndNot.OR);
		MemeIDCritereCollection crit4 = new MemeIDCritereCollection(200, source1, OrAndNot.OR);
		MemeIDCritereCollection crit5 = new MemeIDCritereCollection(250, source1, OrAndNot.OR);
